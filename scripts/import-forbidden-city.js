/*
Import Forbidden City normalized data into Supabase using service-role key.

Usage examples:
  node scripts/import-forbidden-city.js --limit=50 --tables=buildings,facilities --scene-id=a0000000-0000-0000-0000-000000000001
  node scripts/import-forbidden-city.js --limit=0 --tables=all --scene-id=a0000000-0000-0000-0000-000000000001
*/
...
const DATA_PATH = path.join(ROOT, 'scripts', 'data', 'forbidden_city.normalized.json')
const DEFAULT_SCENE_ID = 'a0000000-0000-0000-0000-000000000001'
